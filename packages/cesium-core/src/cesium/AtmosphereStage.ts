...
export interface AtmosphereStageOptions extends AerialPerspectiveFragOptions {
  ...
  /** 月盘亮度倍率（默认 774=160×2.2²——ω 拍板 0.0099 后同式保显示亮度；URL ?moonRadiance=。
  ...
  /** 月盘角半径 rad（默认 0.0099=物理值×2.2，2026-09-01 用户「恢复正常大小」定 0.0045 后反馈
   *  「过小,放大 2.2 倍看看」；~12px 盘径,月海纹理隐约可辨。沿革 0.0135(×3)→0.03(×6.7)→
   *  0.02(×4.4)→0.0045(物理)→0.0099(×2.2)。URL ?moonAngularRadius= 再调）。 */
...
export function validateAtmosphereOptions(
  ...
  return {
    ...
    // 1440×(0.03/0.0135)²≈7111→×(0.02/0.03)²≈3160→×(0.0045/0.02)²≈160→×2.2²≈774。
    moonRadianceScale: options.moonRadianceScale ?? 774,
    moonAngularRadius: options.moonAngularRadius ?? 0.0099,
